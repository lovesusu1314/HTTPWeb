...
void addfd(int epollfd, int fd, bool one_shot){
    ...
    //EPOLLRDHUP  对方连接断开 会出发这个事件（挂起）,如果异常断开了
    //就可以在底层去处理了，就不需要移交给上层
...
//修改文件描述符 重置socket上的EPOLLONESHOT事件，以确保下一次可读时，EPOLLIN能被触发
